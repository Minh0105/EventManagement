    ...
    public List<ScheduleDTO> getListTimingNoti() throws SQLException, NamingException, ParseException{
        ...
        SimpleDateFormat sdf=new SimpleDateFormat("dd/MM/YYYY HH:mm:ss");
         try {
            ...
            if (conn != null) {
                String sql = "SELECT u.eventId eventId, u.runningDate runningDate, v.detail rangeDetail, t.eventName eventName, t.organizerAvatar organizerAvatar\n" +
                                ...
                                " JOIN (SELECT u.id eventId, u.name eventName, v.avatar organizerAvatar FROM tblEvents u JOIN tblUsers v ON u.userId = v.id) t\n" +
                ...
                while (rs.next()) {
                    ...
                    String time = runningDate.substring(0,11) + rs.getString("rangeDetail").substring(0,5) + ":00";
